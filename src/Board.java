...
public class Board extends JPanel implements ActionListener {
    ...
    //Declaring all dimensions related to Board panel
    ...
    //Declaring position of each dots of SnakeGameAccio

    private final int x[] = new int[ALL_DOTS];
    private final int y[] = new int[ALL_DOTS];

    //Declaring SnakeGameAccio size and Apple positions
    ...
    //Call and load images of dots, head and Apple
